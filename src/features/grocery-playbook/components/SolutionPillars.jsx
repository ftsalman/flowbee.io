...
export const SolutionPillars = () => (
  <section className="py-24 bg-gray-50 border-b border-gray-200">
    <div className="max-w-[90rem] mx-auto px-4 md:px-8 space-y-24 md:space-y-32">
      ...
      <motion.article initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
        <div className="space-y-6 md:space-y-8 order-2 lg:order-1 max-w-2xl">
          <div className="w-14 h-14 md:w-20 md:h-20 bg-[#EAB308]/10 rounded-2xl flex items-center justify-center border border-[#EAB308]/20">
            <FiFilter className="text-3xl md:text-4xl text-[#EAB308]" />
          </div>
      ...
      <motion.article initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="space-y-6 md:space-y-8 max-w-2xl lg:pl-8">
          <div className="w-14 h-14 md:w-20 md:h-20 bg-[#25D366]/10 rounded-2xl flex items-center justify-center border border-[#25D366]/20">
            <FiCpu className="text-3xl md:text-4xl text-[#128C7E]" />
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 leading-[1.1]">Auto Reply for <br className="hidden md:block"/><span className="text-[#128C7E]">Supermarket Enquiries</span></h2>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed font-medium">
          ...
          <ul className="space-y-4 md:space-y-6 text-base md:text-lg text-gray-700 font-bold">
            <li className="flex items-start gap-4"><FiCheckCircle className="text-[#EAB308] text-2xl shrink-0 mt-1" /> <span className="flex-1"><strong>Interactive Menus:</strong> "Today's Offers", "Place Order", or "Talk to Staff".</span></li>
            <li className="flex items-start gap-4"><FiCheckCircle className="text-[#EAB308] text-2xl shrink-0 mt-1" /> <span className="flex-1"><strong>Category Routing:</strong> Route clients to Meat & Fish, Bakery, or Fresh Produce instantly.</span></li>
            <li className="flex items-start gap-4"><FiCheckCircle className="text-[#EAB308] text-2xl shrink-0 mt-1" /> <span className="flex-1"><strong>Logistics Info:</strong> Auto-reply with delivery areas, minimum order values, and store locations.</span></li>
          </ul>
        </div>
      </motion.article>
      ...
      <motion.article initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
        <div className="space-y-6 md:space-y-8 order-2 lg:order-1 max-w-2xl">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 leading-[1.1]">Manage Broadcast Replies with <span className="text-blue-600">Team Inbox</span></h2>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed font-medium">
          ...
          <ul className="space-y-4 md:space-y-6 text-base md:text-lg text-gray-700 font-bold">
            <li className="flex items-start gap-4"><FiCheckCircle className="text-[#EAB308] text-2xl shrink-0 mt-1" /> <span className="flex-1"><strong>Smart Assignment:</strong> Assign delivery queries to drivers and bulk orders to managers.</span></li>
            <li className="flex items-start gap-4"><FiCheckCircle className="text-[#EAB308] text-2xl shrink-0 mt-1" /> <span className="flex-1"><strong>Status Tracking:</strong> Mark chats as Open, Pending, or Solved to clear order backlogs.</span></li>
            <li className="flex items-start gap-4"><FiCheckCircle className="text-[#EAB308] text-2xl shrink-0 mt-1" /> <span className="flex-1"><strong>Collision Detection:</strong> Avoid two staff members replying to the same customer.</span></li>
          </ul>
        </div>
        <div className="relative w-full flex justify-center items-center order-1 lg:order-2">
      ...
      <motion.article initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="space-y-6 md:space-y-8 max-w-2xl lg:pl-8">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 leading-[1.1]">Make Product Enquiries Easier via <span className="text-purple-600">WhatsApp Catalogues</span></h2>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed font-medium">
