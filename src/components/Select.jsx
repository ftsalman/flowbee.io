...
import { useEffectAfterMount, useDebounce } from "../../lib/turtle-ui/hooks";
...
import { Button, DataList } from "../../lib/turtle-ui/components";
    ...
    <>
      <div className={cn("relative w-full", containerClassName)}>
        <button
          ...
          disabled={disabled}
          className={cn(
            "outline-none text-start w-full px-4 py-2 min-h-11 flex items-center justify-between gap-3 rounded-lg border ",
            inputboxVariants({
                            ...
                            <div
                              ...
                              className={cn(
                                `outline-none px-4 py-2 flex items-center border-b h-10  ${
                                  isSelected
                                    ? "bg-brand-50 border-b-brand-100"
